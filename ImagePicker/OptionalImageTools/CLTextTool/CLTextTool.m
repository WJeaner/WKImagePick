...
+ (BOOL)isAvailable
{
    return ([UIDevice iosVersion] >= 5.0)&& [[CLImageEditorTheme theme] containEditTypeForClass:[self class]];
}
...
- (void)setMenu
{
    ...
    NSArray *_menu = @[
                       @{@"title":@"新建", @"icon":[self imageForKey:kCLTextToolNewTextIconName defaultImageName:@"btn_add.png"]},
                       @{@"title":@"文本", @"icon":[self imageForKey:kCLTextToolEditTextIconName defaultImageName:@"icon.png"]},
                       @{@"title":@"颜色"},
                       @{@"title":@"字体", @"icon":[self imageForKey:kCLTextToolFontIconName defaultImageName:@"btn_font.png"]},
