...
- (BOOL)containEditTypeForClass:(id)aClass {
    NSString *classString = NSStringFromClass(aClass);
    NSArray *toolsArray = @[@"CLDrawTool",@"CLTextTool",@"CLRotateTool",@"CLClippingTool",@"CLMosaicTool"];
    return [toolsArray containsObject:classString];
}
